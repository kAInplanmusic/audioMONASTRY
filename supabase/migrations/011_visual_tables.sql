-- ============================================================================
-- Konsolidierung DB-P2-001 (2026-09-23) - HERKUNFT: database/ai_migration_008_visual.sql
-- ============================================================================
-- Warum diese Datei hier liegt:
-- Fehlte im supabase-Satz: visual_generations, visual_feedback,
-- visual_embeddings samt HNSW-Index, service-only-Policies und der RPC
-- match_visuals (Visual-Selbstlernen, VISUAL-*-Positionen im SSOT).
--

-- ============================================================================
-- Konsolidierung DB-P2-001 (2026-09-23) - HERKUNFT: database/ai_migration_007.sql
-- ============================================================================
-- Warum diese Datei hier liegt:
-- Fehlte im supabase-Satz: sample_audio_embeddings samt HNSW-Index und die
-- RPCs match_audio_samples / sample_audio_embedding_stats. Aufrufer ist
-- server/routes/mediaRoutes.ts (aiPersistence.rpcMatchAudioSamples).
--

 ...
 * Aktiv/Aufgeklappt = cyan umrandet; OFF = gedimmt; PRO rendert den Inhalt.
 */
  ...
  return (
    <section
      ...
      className={`rounded-xl border transition-all duration-300 ${
        active
          ? 'border-cyan-400/60 bg-cyan-950/10 shadow-[0_0_24px_-8px_rgba(34,211,238,0.45)]'
      ...
      <div className="flex items-center gap-3 px-3 py-2">
        <button
          ...
          className={`w-10 h-10 shrink-0 rounded-lg border flex items-center justify-center transition-all cursor-pointer ${
            pro
              ...
              : active
                ? 'bg-cyan-900/40 border-cyan-400/70 text-cyan-300 shadow-[0_0_12px_rgba(34,211,238,0.35)]'
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-[9px] font-mono tracking-widest flex items-center gap-2">
            <span className={active ? 'text-cyan-400' : 'text-neutral-600'}>{state}</span>
        ...
        <button
          ...
          className={`w-9 h-9 shrink-0 rounded-full border flex items-center justify-center transition-all cursor-pointer ${
            active
              ? 'border-cyan-300/70 bg-cyan-400/10 text-cyan-300 shadow-[0_0_14px_rgba(34,211,238,0.6)]'

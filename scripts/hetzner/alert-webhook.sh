#!/usr/bin/env bash
# =============================================================================
# audioMONASTRY alert-webhook – einfacher Health->Webhook-Alarm (Discord/Slack)
# -----------------------------------------------------------------------------
...
LOG="${LOG:-/var/log/audiomonastry-alert.log}"
ts() { date -u +%FT%TZ; }
...
MSG="⚠️ audioMONASTRY App nicht erreichbar: $APP_URL ($(ts))"
echo "[alert] $MSG" >> "$LOG"

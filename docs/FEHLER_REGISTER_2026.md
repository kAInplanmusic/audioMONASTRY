...
| FR-016 | HF live | Hoch | Endpoint audiomonastry-ai nach AST-Test auf `failed` zurückgefallen (Orchestrator: BAD_REQUEST) | ✅ Gefixt (GHCR-PAT + Task-Normalisierung) | 9g / hf-endpoint.yml |

/* tslint:disable */
/* eslint-disable no-undef, no-unused-vars, no-console, no-constant-condition, no-control-regex, no-useless-escape */
/* prettier-ignore */
...
function isMusl() {
  ...
  if (!process.report || typeof process.report.getReport !== 'function') {
    try {
      // S4036: feste absolute Pfade statt `which` über PATH (kein execSync).
      const lddPath = ['/usr/bin/ldd', '/bin/ldd', '/usr/lib/ldd'].find((p) => existsSync(p))
      return lddPath ? readFileSync(lddPath, 'utf8').includes('musl') : true
    } catch (e) {
      return true
    }
  } else {
